...
const domains = [
  ...
  { name: "Neuroscience", category: "science", emoji: "🧠", color: "bg-blue-100" },
  { name: "Psychology", category: "science", emoji: "💡", color: "bg-purple-100" },
  { name: "Quantum Computing", category: "science", emoji: "⚛️", color: "bg-indigo-100" },
  { name: "Consciousness", category: "science", emoji: "👁️", color: "bg-fuchsia-100" },
  { name: "Books", category: "education", emoji: "📚", color: "bg-orange-100" },
  { name: "Tools", category: "education", emoji: "🛠️", color: "bg-slate-100" },
  { name: "Startup", category: "business", emoji: "🚀", color: "bg-orange-100" },
  ...
  { name: "Foodie", category: "lifestyle", emoji: "🥘", color: "bg-red-100" },
  { name: "Gardening", category: "lifestyle", emoji: "🌿", color: "bg-green-100" },
  { name: "Indoor Sports", category: "lifestyle", emoji: "🏸", color: "bg-blue-100" },
  { name: "Outdoor Sports", category: "lifestyle", emoji: "⚽", color: "bg-emerald-100" },
