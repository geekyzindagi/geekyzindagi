...
const categories = [
  ...
  { id: "education", label: "Knowledge", emoji: "📚" },
...
const domains = [
  ...
  { name: "Quantum Computing", category: "science", emoji: "⚛️", color: "from-blue-500 to-purple-500" },
  { name: "Consciousness", category: "science", emoji: "👁️", color: "from-indigo-500 to-rose-500" },
  { name: "Books", category: "education", emoji: "📚", color: "from-orange-500 to-amber-500" },
  { name: "Tools", category: "education", emoji: "🛠️", color: "from-slate-400 to-slate-600" },
  ...
  { name: "Foodie", category: "lifestyle", emoji: "🥘", color: "from-red-400 to-orange-500" },
  { name: "Gardening", category: "lifestyle", emoji: "🌿", color: "from-green-500 to-emerald-500" },
  { name: "Indoor Sports", category: "lifestyle", emoji: "🏸", color: "from-blue-400 to-indigo-500" },
  { name: "Outdoor Sports", category: "lifestyle", emoji: "⚽", color: "from-lime-500 to-green-600" },
